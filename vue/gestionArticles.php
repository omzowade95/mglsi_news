    ...
    <body>
        <div class="sidebar">
            ...
            <ul class="nav-list">
              ...
              <li>
               <a href="/mglsi_news_simple/vue/gestionCategories.php">
                 <i class='bx bx-grid-alt' ></i>
               		...
               		<div class="table-wrapper">
               			<div class="table-title">
               				<div class="row">
               					...
               					<div class="col-sm-6">
               						<a href="/mglsi_news_simple/CRUD/CRUD_Articles/add.php" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Creer Article</span></a>
               				    ...
               				    <?php if(!empty($articles)): ?>
               				        <?php foreach ($articles as $article): ?>
                                        <tr>
                                            ...
                                            <td><?= $article[5] ?></td>
                                            <td>
                                                <a href="/mglsi_news_simple/CRUD/CRUD_Articles/update.php?edit=<?php echo $article[0];?>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="/mglsi_news_simple/CRUD/CRUD_Articles/delete.php?del=<?php echo $article[0];?>" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                <?php else: ?>
