               ...
               <div class="container-xl">
                    ...
                    <form method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" value="<?php echo $email; ?>"required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Role</label>
                                <input type="number" class="form-control" name="role" value="<?php echo $role; ?>"required>
                            </div>
                        </div>
                ...
                <?php
                    if(isset($_POST['modifier']) == 'Save'){
                        ...
                        $data ="UPDATE users SET username='$username', password='$password',email='$email',role_id='$role' WHERE id= $id" ;
