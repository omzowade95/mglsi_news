               ...
               <div class="container-xl">
                    ...
                    <form method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="pass" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>email</label>
                            ...
                            <div class="form-group">
                                <label>Role_Id</label>
                                <input type="number" class="form-control" min="1" max ="2" name="role"required>
                            </div>
                        </div>
                ...
                <?php
                    if(isset($_POST['ajouter']) == 'Add'){
                        ...
                        $data = "INSERT INTO users(username,password,email,role_id)
                                        VALUE('$username','$pass','$email','$role')";
