          ...
          <section class="home-section">
               <div class="container-xl">
                    ...
                    <?php
                            ...
                            $data = "Select * FROM categorie WHERE id = $id ";
                    ...
                    <form method="POST">
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Libelle</label>
                                <input type="text" class="form-control" name = "libelle" value="<?php echo $libelle; ?>"required>
                            </div>
                        </div>
                ...
                <?php
                    if(isset($_POST['modifier']) == 'Save'){
                        ...
                        $data ="UPDATE categorie SET libelle='$libelle' WHERE id= $id" ;
